...
env_orig <- read.csv(file.path(dataPath,"inputs/LDnoSBlo02_env_sort_2022-10-21.csv")) %>% as.data.frame
otu_orig <- read.csv(file.path(dataPath,"inputs/LDnoSBlo02_otu_sort_2022-10-21.csv")) %>% as.data.frame
...
# HARD DATSET
write.csv(otu_hard, file=file.path(dataPath,(paste0("inputs/SHELFhard_otu_", Sys.Date(),".csv"))))
write.csv(env_hard, file=file.path(dataPath,(paste0("inputs/SHELFhard_env_", Sys.Date(),".csv"))))

# SOFT DATASET
write.csv(otu_soft, file=file.path(dataPath,(paste0("inputs/SHELFsoft_otu_", Sys.Date(),".csv"))))
write.csv(env_soft, file=file.path(dataPath,(paste0("inputs/SHELFsoft_env_", Sys.Date(),".csv"))))
```

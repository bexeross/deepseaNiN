...
```{r}
geodist_pa<-readRDS(file.path(dataPath,"inputs/LoDensNoSB_geodist_pa.rds"))
geodist_r6<-readRDS(file.path(dataPath,"inputs/LoDensNoSB_geodist_r6.rds"))

mds_pa<-readRDS(file.path(dataPath,"inputs/LoDensNoSB_mds_pa.rds"))
mds_r6<-readRDS(file.path(dataPath,"inputs/LoDensNoSB_mds_r6.rds"))
#mds_r6_1000<-readRDS(file.path(dataPath,"inputs/LoDensNoSB_mds_r6_1000rep.rds"))
...
```{r}
saveRDS(geodist_pa,
        file = (file.path(dataPath,"inputs/LoDensNoSB_geodist_pa.rds")))
```
...
```{r}
saveRDS(mds_pa,
        file = file.path(dataPath,"inputs/LoDensNoSB_mds_pa.rds"))
```
...
png(file=file.path(dataPath,"outputs/LoDensNoSB_procrustes_pa.png"), width=1000, height=700)
plot(procr_pa)
dev.off()
```
...
##### Save the figure
```{r}
ggsave(filename = file.path(dataPath,"outputs/LoDensNoSB_correlationPCAvsNMDS_PA.png"),
       device = "png",
       dpi=300 )
...
```{r}
saveRDS(geodist_r6,
        file = (file.path(dataPath,"inputs/LoDensNoSB_geodist_r6.rds")))
```
...
```{r}
saveRDS(mds_r6,
        file = file.path(dataPath,"inputs/LoDensNoSB_mds_r6.rds")) 
```
...
png(file.path(dataPath,"outputs/LoDensNoSB_procrustes_r6.png"), width=1000, height=700,) #added 1000
plot(procr_r6)
dev.off()
```
...
##### Save the figure
```{r}
ggsave(filename = file.path(dataPath,"outputs/LoDensNoSB_correlationPCAvsNMDS_r6.png"),
       device = "png",
       dpi=300 )
...
##### Save the figure
```{r}
ggsave(file.path(dataPath,"outputs/LoDensNoSB_gnmds_dca_r6.png"),
       device = "png", 
       dpi=300)
```
...
write.csv(x = cor_tab,
          file = file.path(dataPath,"inputs/LoDensNoSB_cor-table_r6_200rep_MLD-bathy.csv"),
          row.names = FALSE)
```
...
ggexport(ordsrfs_plt,
          filename = file.path(dataPath,"outputs/LoDensNoSB_ordisurfs_top_corr.png"),
          width = 2000,
          height = 2500)
...
ggexport(ordsrfs_plt_m,
          filename = file.path(dataPath,"outputs/LoDensNoSB_ordisurfs_man_sel.png"),
          width = 2000,
          height = 2000)
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/LoDensNoSB_EnvFit_man_sel_cln.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/LoDensNoSB_gnmds_MLDmeanBathy.png"),
       device = "png",
       dpi=300 )
```
#### gnmds w sedclass
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/LoDensNoSB_gnmds_sedclass.png"),
       device = "png",
       dpi=300 )
```
#### gnmds w lanscape
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/LoDensNoSB_gnmds_landscape.png"),
       device = "png",
       dpi=300 )
```
...
ggexport(cat_var_plots,
          filename = file.path(dataPath,"outputs/LoDensNoSB_gnmds_catvar.png"),
          width = 1000,
          height = 800)
```

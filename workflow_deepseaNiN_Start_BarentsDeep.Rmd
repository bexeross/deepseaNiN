...
```{r}
saveRDS(geodist_pa,
        file = (file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep_geodist_pa.rds")))
```
...
```{r}
saveRDS(mds_pa,
        file = file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep_mds_pa.rds"))
```
...
```{r}
saveRDS(geodist_r6,
        file = (file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep_geodist_r6.rds")))
```
...
```{r}
saveRDS(mds_r6,
        file = file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep_mds_r6.rds")) 
```
...
write.csv(x = cor_tab,
          file = file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep_cor-table_r6_200rep_MLD-bathy.csv"),
          row.names = FALSE)
```
...
c25 <- c(
  ...
  "#FDBF6F", # lt orange
  "gray70", "khaki2",
  "maroon", "orchid1", "BarentsDeeppink1", "blue1", "steelblue4",

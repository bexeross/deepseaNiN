...
env_sort <- read.csv(file.path(dataPath,"inputs/BarentsDeep_env_sort_2022-09-28.csv")) %>% as.data.frame
otu_sort <- read.csv(file.path(dataPath,"inputs/BarentsDeep_otu_sort_2022-09-28.csv")) %>% as.data.frame

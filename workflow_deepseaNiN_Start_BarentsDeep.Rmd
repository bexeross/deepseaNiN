...
env_sort <- rbind(env_sort1,env_sort2)
otu_sort <- rbind(otu_sort1, otu_sort2)
```
...
```{r}
## Removing NAs
otuCompl <- otu_sort[complete.cases(env_sort[, -c(1:which(colnames(otu_sort)=="Acesta_excavata")-1)]), ]

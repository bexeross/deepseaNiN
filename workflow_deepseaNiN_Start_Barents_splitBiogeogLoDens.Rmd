---
title: "MAREANO - NiN:splitting biogeographic regions_Barents_below100_"
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_bathy_v_temp_nmds1.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_bathy_v_temp_salinityMax.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_bathy_v_temp_longitude.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_bathy_v_temp_latitude.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_bathy_v_temp_iceCovLTmax.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_bathy_v_salMax_temp.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_tempRmean_v_salinityRmax_nmds1.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_tempRmean_v_salinityRmax_disooxmean.png"),
       device = "png",
       dpi=300 )
```
##### TS - icecoverLTMax
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_tempRmean_v_salinityRmax_iceCoveLTmax.png"),
       device = "png",
       dpi=800 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__X_v_Y_tmeanR.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__X_v_Y_swDenRobavs.png"),
       device = "png",
       dpi=800 )
```
##### X v Y - dissox
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__X_v_Y_dissox.png"),
       device = "png",
       dpi=800 )
```
##### X v Y - icecoverLTMax
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__X_v_Y_iceCoveLTmax.png"),
       device = "png",
       dpi=800 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__TmeanR_v_dissoxltmin_gnmds1.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100_TmeanR_v_dissoxltmin_bathy.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__XvY_MLDmeanBathy.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__XvY_ax1cat.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/Barents_below100__XvY_ax2cat.png"),
       device = "png",
       dpi=300 )
...
```{r}
save.image("I:/Scripts/deepseaNiN/Renv_deepseaNiN_Barents_below100_.RData") # edit area first

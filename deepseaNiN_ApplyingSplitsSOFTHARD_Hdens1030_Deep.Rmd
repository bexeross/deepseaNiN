---
title: "Splitting data into SOFT and HARD dasets - for NiN v 3 analyses - R Notebook. HiDens1030 Deep"
...
env_orig <- read.csv(file.path(dataPath,"inputs/HDensDeep_env_sort_2022-10-25.csv")) %>% as.data.frame
otu_orig <- read.csv(file.path(dataPath,"inputs/HDensDeep_otu_sort_2022-10-25.csv")) %>% as.data.frame
...
# HARD DATSET
write.csv(otu_hard, file=file.path(dataPath,(paste0("inputs/HDens1030_hard_otu_", Sys.Date(),".csv"))))
write.csv(env_hard, file=file.path(dataPath,(paste0("inputs/HDens1030_hard_env_", Sys.Date(),".csv"))))

# SOFT DATASET
write.csv(otu_soft, file=file.path(dataPath,(paste0("inputs/HDens1030_soft_otu_", Sys.Date(),".csv"))))
write.csv(env_soft, file=file.path(dataPath,(paste0("inputs/HDens1030_soft_env_", Sys.Date(),".csv"))))
```

...
31.10.22  Update to envDataOslo_2022-10-19, widedataOslo_2022-10-19
1.11.22 update to envDataOslo_2022-10-19, widedataOslo_2022-10-19
...
otuCompl$SpR<-rowSums(otuCompl[,c(3:(which(colnames(otuCompl)=="Weberella_bursa")))]!=0)
...
```{r}
otu_6$spRich<-rowSums(otu_6[,c(1:which(colnames(otu_6)=="Weberella_bursa"))]!=0)
...
LDensShlw_otu_sort<-loDensShallowJoinedDat %>% select(c(2:which(colnames(joinedDat)=="Weberella_bursa")))
LDensShlw_env_sort<-loDensShallowJoinedDat %>% select(c(2,(which(colnames(joinedDat)=="Weberella_bursa")+1):which(colnames(joinedDat)=="sand")))                                


hiDensDeepJoinedDat<-subset(joinedDat,swDensRob_avs>1030)
plot(hiDensDeepJoinedDat$X.y, hiDensDeepJoinedDat$Y)
HDensDeep_otu_sort<-hiDensDeepJoinedDat %>% select(c(2:which(colnames(joinedDat)=="Weberella_bursa")))
HDensDeep_env_sort<-hiDensDeepJoinedDat %>% select(c(2,(which(colnames(joinedDat)=="Weberella_bursa♥")+1):which(colnames(joinedDat)=="sand")))  
```

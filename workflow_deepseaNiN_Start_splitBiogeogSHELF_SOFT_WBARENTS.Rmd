...
xy_t<- ggplot(data = env_sub_meta,
  ...
  scale_colour_gradientn(limits = c(min(env_sub_meta$BO22_dissoxltmin_bdmean), 
                                    max(env_sub_meta$BO22_dissoxltmin_bdmean)), #match variable acting as colour
                        colors=c('blue','green','red'))+
  ggtitle("Geography (X v Y) - coloured by dissox lt min") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WBARENTS__X_v_Y_dissoxltmin.png"), #amend
       device = "png",
       dpi=300 )
```
...
xy_t<- ggplot(data = env_sub_meta,
  ...
  scale_colour_gradientn(limits = c(min(env_sub_meta$Smean_Robinson), 
                                    35.05), #match variable acting as colour
                        colors=c('blue','green','red'))+
  ggtitle("Geography (X v Y) - coloured by Salinity (meanR) thresh 35.05") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WBARENTS__X_v_Y_SmeanR_thresh35pt05.png"), #amend
       device = "png",
       dpi=300 )
```

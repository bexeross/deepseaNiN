...
env_sort <-env_sort %>% filter(!(SampID %in% c("2057_00","2181_00")))

otu_sort <-otu_sort %>% filter(!(SampID %in% c("2057_00","2181_00")))
```
...
```{r}
saveRDS(geodist_pa,
        file = (file.path(dataPath,"inputs/SPLITS/DEEP/hiDens_b1500_geodist_pa.rds")))
```

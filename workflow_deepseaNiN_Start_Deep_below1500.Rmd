---
title: "MAREANO - NiN - hi Dens below 1500m depth"
...
geodist_r6<-readRDS(file.path(dataPath,"inputs/SPLITS/DEEP/hiDens_b1500_geodist_r6.rds"))

mds_pa<-readRDS(file.path(dataPath,"inputs/SPLITS/DEEP/hiDens_b1500_mds_pa.rds"))
mds_r6<-readRDS(file.path(dataPath,"inputs/SPLITS/DEEP/hiDens_b1500_mds_r6.rds"))
#mds_r6_1000<-readRDS(file.path(dataPath,"inputs/SPLITS/DEEP/hiDens_b1500_mds_r6_1000rep.rds"))
...
env_sort <- read.csv(file.path(dataPath,"inputs/SPLITS/DEEP/DeepBelow1500_env_sort_2022-09-29.csv")) %>% as.data.frame
otu_sort <- read.csv(file.path(dataPath,"inputs/SPLITS/DEEP/DeepBelow1500_otu_sort_2022-09-29.csv")) %>% as.data.frame

---
title: "MAREANO - NiN:splitting biogeographic regions_BarentsDeep10Oct"
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_bathy_v_temp_nmds1.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_bathy_v_temp_salinityMax.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_bathy_v_temp_longitude.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_bathy_v_temp_latitude.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_bathy_v_temp_iceCovLTmax.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_bathy_v_salMax_temp.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_tempRmean_v_salinityRmax_nmds1.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_tempRmean_v_salinityRmax_disooxmean.png"),
       device = "png",
       dpi=300 )
```
##### TS - icecoverLTMax
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_tempRmean_v_salinityRmax_iceCoveLTmax.png"),
       device = "png",
       dpi=800 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__X_v_Y_tmeanR.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__X_v_Y_swDenRobavs.png"),
       device = "png",
       dpi=800 )
```
##### X v Y - dissox
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__X_v_Y_dissox.png"),
       device = "png",
       dpi=800 )
```
##### X v Y - icecoverLTMax
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__X_v_Y_iceCoveLTmax.png"),
       device = "png",
       dpi=800 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__TmeanR_v_dissoxltmin_gnmds1.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_TmeanR_v_dissoxltmin_bathy.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__XvY_MLDmeanBathy.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__XvY_ax1cat.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__XvY_temp5_1.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__XvY_dissoxav305.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__XvY_iceLTmx_gt0.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__XvY_ax2cat.png"),
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__gnmds_temp5_1.png"),
       device = "png",
       dpi=300 )
```
#### Gnmds w dissox 305
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__gnmds_dissox305.png"),
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct__gnmds_iceMxgt0.png"),
       device = "png",
       dpi=300 )
```
...
ggexport(comp,
          filename = file.path(dataPath,"outputs/BarentsDeep10Oct__gnmds_compare.png"),
          width = 1500,
          height = 500)
...
i_gmo <- ggplot(data = env_sub_meta,
  ...
  theme_classic() +
  coord_fixed() +
  ggtitle("GNMDS coloured by region",
          subtitle = "First run") +
...
```{r}
save.image("I:/Scripts/deepseaNiN/Renv_deepseaNiN_BarentsDeep10Oct_.RData") # edit area first

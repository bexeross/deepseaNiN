...
ggplot(data = env_vis_temp,
  ...
  geom_point(data =XXX[!is.na(XXX$SpickSpong_Sum) & XXX$SpickSpong_Sum>0,],  aes(colour = SpickSpong_Sum), alpha = 0.3) +
  geom_vline(xintercept = 0,
             linetype = 2,
             colour = "lightgray") +
  geom_hline(yintercept = 0,
...
ggplot(data = env_vis_temp,
  ...
  ggtitle("DCA coloured by Spickle sponges density",
          subtitle = "First run") +
  geom_point(color = "grey") +
  geom_point(data =XXX[!is.na(XXX$SpickSpong_Sum) & XXX$SpickSpong_Sum>0,],  aes(colour = log(SpickSpong_Sum)), alpha = 0.3) +
  geom_vline(xintercept = 0,
             linetype = 2,
             colour = "lightgray") +
  geom_hline(yintercept = 0,
...
ggplot(data = env_vis_temp,
  ...
  ggtitle("GNMDS coloured by Lophelia density",
          subtitle = "First run") +
  geom_point(color = "grey") +
  geom_point(data =XXX[!is.na(XXX$Lophelia_pertusa) & XXX$Lophelia_pertusa>0,],  aes(colour = Lophelia_pertusa), alpha = 0.3) +
  geom_vline(xintercept = 0,
             linetype = 2,
             colour = "lightgray") +
  geom_hline(yintercept = 0,
...
env_sel_locations_Lophelia_Paragorgia<- ggplot(data = env_vis_temp,
                      aes(x = X.y,
                          y = Y)) +
  theme_classic() +
  geom_point(data = XXX[XXX$Lophelia_Paragorgia == 0,],colour = "gray",
             size = 2, alpha = 0.5) +
   geom_point(data = XXX[XXX$Lophelia_Paragorgia > 0,], aes(colour = Lophelia_Paragorgia),
             size = 2, alpha = 0.5) +
  scale_colour_gradient2(low = "green",
                         mid = "yellow",
                         high = "red") +

...
env_sort <- read.csv(file.path(dataPath,"inputs/SPLITS/SHELF/SH_WB_NAW_soft_env_2022-10-25.csv")) %>% as.data.frame
otu_sort <- read.csv(file.path(dataPath,"inputs/SPLITS/SHELF/SH_WB_NAW_soft_otu_2022-10-25.csv")) %>% as.data.frame

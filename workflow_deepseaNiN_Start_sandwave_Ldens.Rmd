...
env_sort <- read.csv(file.path(dataPath,"inputs/SPLITS/sandwave/sandwave_LDens_env_sort_2022-10-13.csv")) %>% as.data.frame
otu_sort <- read.csv(file.path(dataPath,"inputs/SPLITS/sandwave/sandwave_LDens_otu_sort_2022-10-13.csv")) %>% as.data.frame

...
```
#### Show what samples are left after complete cases and >10 OTUs filters
```{r}
...
```
```{r}
ggsave(file.path(dataPath,"outputs/sandwave_Ldens_gnmds_SpRichr6.png"),
       device = "png", 
       dpi=300)
```

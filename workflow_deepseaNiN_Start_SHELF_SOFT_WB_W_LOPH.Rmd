...
ggexport(ordsrfs_plt_m,
          filename = file.path(dataPath,"outputs/SH_SOFT_WB_W_LOPH_ordisurfs_man_sel_domean.png"),
          width = 1000,
          height = 800)
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SH_SOFT_WB_W_LOPH_EnvFit_man_sel_cln_domean.png"),
       device = "png",
       dpi=300 )
```

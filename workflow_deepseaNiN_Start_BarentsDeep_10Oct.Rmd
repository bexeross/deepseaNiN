---
title: "MAREANO - NiN - BarentsDeep10Oct"
...
```{r}
geodist_pa<-readRDS(file.path(dataPath,"inputs/BarentsDeep10Oct__geodist_pa.rds"))
geodist_r6<-readRDS(file.path(dataPath,"inputs/BarentsDeep10Oct__geodist_r6.rds"))

mds_pa<-readRDS(file.path(dataPath,"inputs/BarentsDeep10Oct__mds_pa.rds"))
mds_r6<-readRDS(file.path(dataPath,"inputs/BarentsDeep10Oct__mds_r6.rds"))
...
#BarentsDeep specific
env_sort$X.y<-env_sort$X.y.y
env_sort<-env_sort %>% select(-c("X.y.y"))
```
...
```{r}
saveRDS(geodist_pa,
        file = (file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep10Oct_geodist_pa.rds")))
```
...
```{r}
saveRDS(mds_pa,
        file = file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep10Oct_mds_pa.rds"))
```
...
png(file=file.path(dataPath,"outputs/BarentsDeep10Oct_procrustes_pa.png"), width=1000, height=700)
plot(procr_pa)
dev.off()
```
...
##### Save the figure
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_correlationPCAvsNMDS_PA.png"),
       device = "png",
       dpi=300 )
...
```{r}
saveRDS(geodist_r6,
        file = (file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep10Oct_geodist_r6.rds")))
```
...
```{r}
saveRDS(mds_r6,
        file = file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep10Oct_mds_r6.rds")) 
```
...
png(file.path(dataPath,"outputs/BarentsDeep10Oct_procrustes_r6.png"), width=1000, height=700,) #added 1000
plot(procr_r6)
dev.off()
```
...
##### Save the figure
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_correlationPCAvsNMDS_r6.png"),
       device = "png",
       dpi=300 )
...
##### Save the figure
```{r}
ggsave(file.path(dataPath,"outputs/BarentsDeep10Oct_gnmds_dca_r6.png"),
       device = "png", 
       dpi=300)
```
...
write.csv(x = cor_tab,
          file = file.path(dataPath,"inputs/SPLITS/DEEP/BarentsDeep10Oct_cor-table_r6_200rep_MLD-bathy.csv"),
          row.names = FALSE)
```
...
ggexport(ordsrfs_plt,
          filename = file.path(dataPath,"outputs/BarentsDeep10Oct_ordisurfs_top_corr.png"),
          width = 2000,
          height = 2500)
...
ggexport(ordsrfs_plt_m,
          filename = file.path(dataPath,"outputs/BarentsDeep10Oct_ordisurfs_man_sel_domean.png"),
          width = 2000,
          height = 2000)
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/BarentsDeep10Oct_EnvFit_man_sel_cln_domean.png"),
       device = "png",
       dpi=300 )
```
...
c25 <- c(
  ...
  "#FDBF6F", # lt orange
  "gray70", "khaki2",
  "maroon", "orchid1", "BarentsDeep10Octpink1", "blue1", "steelblue4",
...
ggexport(cat_var_plots,
          filename = file.path(dataPath,"outputs/BarentsDeep10Oct_gnmds_catvar.png"),
          width = 1000,
          height = 800)
```

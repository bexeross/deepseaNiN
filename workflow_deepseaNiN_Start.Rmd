...
tb_ax1<- ggplot(data = env_sub_meta,
  ...
  scale_colour_gradient2(low = "red",
                         mid = "yellow",
                         high = "green") +
  ggtitle("Temp (mean Robinson) v disox lt min - coloured by gnmds r6 200 rep axis 1")
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/TmeanR_v_dissoxltmin_nmds1.png"),
       device = "png",
       dpi=300 )
```

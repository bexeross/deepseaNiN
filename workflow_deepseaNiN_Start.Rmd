...
mds_r6_1000rep<-readRDS(file.path(dataPath,"inputs/mds_r6_1000rep.rds"))
...
# Extracting ordination axis
ax <- 2
axis_r6 <- cbind(mds_best_r6_1000$points,
                 scores(dca_r6,
                        display = "sites",
                        origin = TRUE)[, 1:ax])
...
otu_6$gnmds1 <- mds_best_r6_1000$points[, 1]
otu_6$gnmds2 <- mds_best_r6_1000$points[, 2]
...
env_os_m <- env[, c("Tmean_Robinson", #top corr
                  ...
                  "BO22_icecoverltmax_ss",#top corr
                  ...
                  #"BO22_lightbotltmin_bdmean", #highest rep of shallow water differences
                  "MLDmin-bathy", #curiosity/comparison to highest rep of shallow water differences
...
colnames(env_os_m_envfit)<-c("TmeanR", #top corr
                 ...
                 # "lightbotltmin", #highest rep of shallow water differences
                #  "MLDmin-bathy", #curiosity/comparison to highest rep of shallow water differences
                  "bathy" #intuitive for comparisons 
                 )

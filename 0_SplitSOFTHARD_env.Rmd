...
# env_orig<-env_orig %>% 
#   rowwise() %>%
#   mutate(HardNGUClass=sum(c_across(all_of(hardNGUCats)),na.rm=T),
#          CoarseNGUClass=sum(c_across(all_of(coarseNGUCats)),na.rm=T),
#          SoftNGUClass=sum(c_across(all_of(softNGUCats)),na.rm=T))

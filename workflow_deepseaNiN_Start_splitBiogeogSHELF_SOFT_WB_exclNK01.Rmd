...
xy_t<- ggplot(data = env_sub_meta,
  ...
  scale_colour_gradientn(limits = c(min(env_sub_meta$gnmds1), 
                                    max(env_sub_meta$gnmds1)), #match variable acting as colour
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_gnmds1.png"), #amend
       device = "png",
       dpi=300 )
```
#### X v Y - gnmds2
...
xy_t<- ggplot(data = env_sub_meta,
  ...
  geom_point(aes(colour = gnmds1),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$gnmds2), 
                                    max(env_sub_meta$gnmds2)), #match variable acting as colour
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_gnmds2.png"), #amend
       device = "png",
       dpi=300 )
```
#### X v Y - ax1x2
...
xy_t<- ggplot(data = env_sub_meta,
                      aes(x = X,
                          y = Y)) +
  theme_classic() +
  geom_point(aes(colour = ax1x2),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$ax1x2), 
                                    max(env_sub_meta$ax1x2)), #match variable acting as colour
                        colors=c('blue','green','red'))+
  ggtitle("Geography (X v Y) - coloured by gnmds1*gnmds2 (ax1x2)") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_ax1x2.png"), #amend
       device = "png",
       dpi=300 )
```
...
xy_t<- ggplot(data = env_sub_meta,
  ...
  geom_point(aes(colour = BO22_dissoxmean_bdmean),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$BO22_dissoxmean_bdmean), 
                                    max(env_sub_meta$BO22_dissoxmean_bdmean)), #match variable acting as colour
                        colors=c('blue','green','red'))+
  ggtitle("Geography (X v Y) - coloured by dissox mean") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_dissoxmean.png"), #amend
       device = "png",
       dpi=300 )
```
#### X v Y - dissox lt min threshold 300.5
```{r}
xy_t<- ggplot(data = env_sub_meta,
                      aes(x = X,
                          y = Y)) +
  ...
  geom_point(aes(colour = BO22_dissoxmean_bdmean),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$BO22_dissoxmean_bdmean), 
                                    300.5), #match variable acting as colour
                        colors=c('red'))+
  ggtitle("Geography (X v Y) - coloured by dissox mean with threshold 300.5") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_dissoxmean_thresh300pt5.png"), #amend
       device = "png",
       dpi=300 )
```
...
gnmds_spR <- ggplot(data = env_sub_meta,
  ...
  theme_classic() +
  coord_fixed() +
  ggtitle("GNMDS coloured by dissox lt min")+ #amend
  geom_point(aes(colour = BO22_dissoxltmin_bdmean)) + #change at will - continuous vars only
  scale_colour_gradientn(limits = c(min(env_sub_meta$BO22_dissoxltmin_bdmean),max(env_sub_meta$BO22_dissoxltmin_bdmean)),#match variable acting as colour
                        colors=c('blue','green','red'))+
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01_gnmds_dissoxltmin.png"), #amend
       device = "png",
       dpi=300 )
```
...
xy_t<- ggplot(data = env_sub_meta,
                      aes(x = X,
                          y = Y)) +
  theme_classic() +
  geom_point(aes(colour = Smean_Robinson),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$Smean_Robinson), 
                                    max(env_sub_meta$Smean_Robinson)), #match variable acting as colour
                        colors=c('red','yellow','blue'))+ #for binary plots
                        #colors=c('blue','green','red'))+ #for contnuous plots
  ggtitle("Geography (X v Y) - coloured by Salinity (meanR)") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_SmeanR.png"), #amend
       device = "png",
       dpi=300 )
```
...
xy_t<- ggplot(data = env_sub_meta,
  ...
  geom_point(aes(colour = Smin_Robinson),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$Smin_Robinson), 
                                    max(env_sub_meta$Smin_Robinson)), #match variable acting as colour
                        colors=c('blue','green','red'))+
  ggtitle("Geography (X v Y) - coloured by Salinity (minR)") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_SminR.png"), #amend
       device = "png",
       dpi=300 )
```
#### X v Y - Salt Max
...
xy_t<- ggplot(data = env_sub_meta,
  ...
  geom_point(aes(colour = Smax_Robinson),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$Smax_Robinson), 
                                    max(env_sub_meta$Smax_Robinson)), #match variable acting as colour
                        colors=c('blue','green','red'))+
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_SmaxR.png"), #amend
       device = "png",
       dpi=300 )
```


#### X v Y with proximity to mixed layer
```{r}
cat_xy_ax1 <- ggplot(data = env_sub_meta,
 ...
 # scale_colour_brewer(palette = "Spectral") + # ordered colourblind pallette
  ggtitle("Easting vs Northing - coloured by proximity to mixed layer") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__XvY_MLDmean_bathy.png"), #amend
       device = "png",
       dpi=300 )
...
cat_xy_ax1 <- ggplot(data = env_sub_meta,
              aes(x = X,
                  y = Y)) +
  theme_classic() +
  geom_point(aes(colour = BiotopeDesc), #change at will - categorical vars only
             size = 1) +
  scale_colour_manual(values=rev(col_vector)) +# non-ordered colourblind pallette
 # scale_colour_brewer(palette = "Spectral") + # ordered colourblind pallette
  ggtitle("Easting vs Northing - coloured by MAREANO 03.22 biotope") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__XvY_biotope.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01_bathy_v_temp_nmds1.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01_bathy_gnmds_spR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01_bathy_dca_spR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__X_v_Y_tmeanR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__gnmds_gmo.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__XvY_ax1cat.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save some outputs
ggexport(comp,
          filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_exclNK01__compare.png"), #amend
...
```{r}
#save.image("I:/Scripts/deepseaNiN/Renv_deepseaNiN_SHELF_SOFT_WB_exclNK01_.RData") # edit area first

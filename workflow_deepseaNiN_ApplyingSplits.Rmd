...
# MAKE CW DATASET
loDensNoSBmidO2lowSJoinedDat<-subset(loDensNoSBmidO2JoinedDat,Smean_Robinson<=35)
plot(loDensNoSBmidO2lowSJoinedDat$X.y, loDensNoSBmidO2lowSJoinedDat$Y)
loDensNoSBmidO2lowS_otu_sort<-loDensNoSBmidO2lowSJoinedDat %>% select(c(2:251))#dataset 19-10-22 or after
loDensNoSBmidO2lowS_env_sort<-loDensNoSBmidO2lowSJoinedDat %>% select(c(2,257:392)) #dataset 19-10-22 or after
# LDnoSBhi02_otu_sort<-loDensNoSBhiO2JoinedDat %>% select(c(2:391))#dataset before 19-10-22
# LDnoSBhi02_env_sort<-loDensNoSBhiO2JoinedDat %>% select(c(2,397:532)) #dataset before 19-10-22 


# MAKE NAW DATASET
loDensNoSBmidO2hiSJoinedDat<-subset(loDensNoSBmidO2JoinedDat,Smean_Robinson>35)
plot(loDensNoSBmidO2hiSJoinedDat$X.y, loDensNoSBmidO2hiSJoinedDat$Y)
loDensNoSBmidO2hiS_otu_sort<-loDensNoSBmidO2hiSJoinedDat %>% select(c(2:251))#dataset 19-10-22 or after
loDensNoSBmidO2hiS_env_sort<-loDensNoSBmidO2hiSJoinedDat %>% select(c(2,257:392))  #dataset 19-10-22 or after 
# LDnoSBlo02_otu_sort<-loDensNoSBloO2JoinedDat %>% select(c(2:391))#dataset before 19-10-22
# LDnoSBlo02_env_sort<-loDensNoSBloO2JoinedDat %>% select(c(2,397:532))  #dataset before 19-10-22  
...
```{r}
# WBARENTS CW DATASET
write.csv(loDensNoSBmidO2lowS_otu_sort, file=file.path(dataPath,(paste0("inputs/loDensNoSBmidO2lowS_WB_CW_otu_sort_", Sys.Date(),".csv"))))
write.csv(loDensNoSBmidO2lowS_env_sort, file=file.path(dataPath,(paste0("inputs/loDensNoSBmidO2lowS_WB_CW_env_sort_", Sys.Date(),".csv"))))

# WBARENTS NAW DATSET
write.csv(loDensNoSBmidO2hiS_otu_sort, file=file.path(dataPath,(paste0("inputs/loDensNoSBmidO2hiS_WB_NAW_otu_sort_", Sys.Date(),".csv"))))
write.csv(loDensNoSBmidO2hiS_env_sort, file=file.path(dataPath,(paste0("inputs/loDensNoSBmidO2hiS_WB_NAW_env_sort_", Sys.Date(),".csv"))))
```

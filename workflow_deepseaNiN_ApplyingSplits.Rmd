...
```{r}
DeepBelow1500<-subset(hiDensDeepJoinedDat,bathy>"-1500")
...
DeepAbove1500<-subset(hiDensDeepJoinedDat,bathy<"-1500")
...
#loDensNoSBJoinedDat <-loDensShallowJoinedDat %>% filter(!(SampID %in% c("1805_01",
                                                                        ...
                                                                        # "1800_00",
                                                                        # "1995_00")))
loDensNoSBJoinedDat <-subset(loDensShallowJoinedDat, bathy<"-99")

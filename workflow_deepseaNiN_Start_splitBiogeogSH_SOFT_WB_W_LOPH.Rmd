...
xy_t<- ggplot(data = env_sub_meta,
  ...
  geom_point(aes(colour = gnmds1),#change at will - continuous vars only
             size = 1) +
  scale_colour_gradientn(limits = c(min(env_sub_meta$gnmds1), 1.5), #match variable acting as colour
                        colors=c('green','yellow','red'))+
  ggtitle("Geography (X v Y) - coloured by gnmds1 max 1.5") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__X_v_Y_gnmds1_1pt5.png"), #amend
       device = "png",
       dpi=300 )
```
#### X v Y - gnmds2
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__X_v_Y_gnmds2.png"), #amend
       device = "png",
       dpi=300 )
```

#### X v Y with biotope categories
```{r}
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__XvY_biotope.png"), #amend
       device = "png",
       dpi=300 )
...
#### X v Y with SpongSpic
```{r}
cat_xy_ax1 <- ggplot(data = env_sub_meta,
              aes(x = X,
                  y = Y)) +
  theme_classic() +
  geom_point(aes(colour = env_sub_meta$SpongeSpic), #change at will - categorical vars only
             size = 1) +
 scale_colour_manual(values=cbPalette) +# non-ordered colourblind pallette
  #scale_colour_brewer(palette = "Spectral") + # ordered colourblind pallette
  ggtitle("Easting vs Northing - coloured by SpongeSpic bitopes") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__XvY_spoSpicBiotopes.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__gnmds_biotope.png"), #amend
       device = "png",
       dpi=300 )
...
gnmds_gmo <- ggplot(data = env_sub_meta,
  ...
  theme_classic() +
  coord_fixed() +
  ggtitle("GNMDS coloured by Sponge Spicule biotopes",
          subtitle = "First run") +
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__gnmds_sponspicBiotope.png"), #amend
       device = "png",
       dpi=300 )
...
gnmds_gmo <- ggplot(data = env_sub_meta,
  ...
  theme_classic() +
  coord_fixed() +
  ggtitle("GNMDS coloured by sediment dannelse",
          subtitle = "First run") +
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__gnmds_seddanName.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_bathy_v_temp_nmds1.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_bathy_gnmds_spR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__X_v_Y_tmeanR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__gnmds_gmo.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH__XvY_ax1cat.png"), #amend
       device = "png",
       dpi=300 )

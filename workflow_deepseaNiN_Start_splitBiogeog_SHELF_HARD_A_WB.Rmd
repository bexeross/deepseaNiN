...
env_sub_meta1$spRich<-rowSums(otu_6[,-c(1:which(colnames(otu_6)=="Porifera_lily"))]!=0)
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_HARD_ATL_WBW_gnmds_biotope.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_HARD_ATL_WBW_gnmds_seddan.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_HARD_ATL_WBW_gnmds_sedmil.png"), #amend
       device = "png",
       dpi=300 )

...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/sandwave_Ldens_SOFT_EnvFit_man_sel_cln_domean.png"),
       device = "png",
       dpi=300 )
```
...
ggexport(cat_var_plots,
          filename = file.path(dataPath,"outputs/sandwave_Ldens_SOFT_gnmds_catvar.png"),
          width = 1000,
          height = 800)
```

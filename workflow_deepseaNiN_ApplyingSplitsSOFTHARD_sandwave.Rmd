---
title: "Splitting data into SOFT and HARD dasets - for NiN v 3 analyses - SANDWAVE DATASET R Notebook"
...
env_orig <- read.csv(file.path(dataPath,"inputs/SPLITS/sandwave/sandwave_LDens_env_sort_2022-11-01.csv")) %>% as.data.frame
otu_orig <- read.csv(file.path(dataPath,"inputs/SPLITS/sandwave/sandwave_LDens_otu_sort_2022-11-01.csv")) %>% as.data.frame
...
# HARD DATSET
write.csv(otu_hard, file=file.path(dataPath,(paste0("inputs/SPLITS/sandwave/sandwave_LDens_hard_otu_", Sys.Date(),".csv"))))
write.csv(env_hard, file=file.path(dataPath,(paste0("inputs/SPLITS/sandwave/sandwave_LDens_hard_env_", Sys.Date(),".csv"))))

# SOFT DATASET
write.csv(otu_soft, file=file.path(dataPath,(paste0("inputs/SPLITS/sandwave/sandwave_LDens_soft_otu", Sys.Date(),".csv"))))
write.csv(env_soft, file=file.path(dataPath,(paste0("inputs/SPLITS/sandwave/sandwave_LDens_soft_env", Sys.Date(),".csv"))))
```

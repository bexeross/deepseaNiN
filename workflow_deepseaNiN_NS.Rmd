---
title: "MAREANO - NiN: Norland Slope Run"
...
##### Save the figure
```{r}
ggsave(filename = file.path(dataPath,"outputs/NScorrelationPCAvsNMDS_PA.png"),
       device = "png",
       dpi=300 )
...
##### Save the figure
```{r}
ggsave(filename = file.path(dataPath,"outputs/NScorrelationPCAvsNMDS_r6.png"),
       device = "png",
       dpi=300 )
...
##### Save the figure
```{r}
ggsave(file.path(dataPath,"outputs/NSgnmds_dca_r6.png"),
       device = "png", 
       dpi=300)
```
...
T.mds<- ggplot(data = env_vis,
  ...
  ggtitle("Gnmds coloured by temp (NS)")

...
cat_xy_ax1 <- ggplot(data = env_sub_meta,
 ...
 # scale_colour_brewer(palette = "Spectral") + # ordered colourblind pallette
  ggtitle("Easting vs Northing - coloured by SpongeSpic") #amend
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006__XvY_spongeSpic.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006__X_v_Y_gnmds2.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006_bathy_v_temp_nmds1.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006_bathy_gnmds_spR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006_bathy_dca_spR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006__X_v_Y_tmeanR.png"), #amend
       device = "png",
       dpi=300 )
```
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006__gnmds_gmo.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save the plot
```{r}
ggsave(filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006__XvY_ax1cat.png"), #amend
       device = "png",
       dpi=300 )
...
##### Save some outputs
ggexport(comp,
          filename = file.path(dataPath,"outputs/SHELF_SOFT_WB_W_LOPH_x2006__compare.png"), #amend
...
```{r}
#save.image("I:/Scripts/deepseaNiN/Renv_deepseaNiN_SHELF_SOFT_WB_W_LOPH_x2006_.RData") # edit area first
